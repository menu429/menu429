...
               <p>Time Estimated: <select name="time_estimate" id="time_est" multiple onchange="" size="1">
...
               <p>Category: <select name="category_type" id="category" multiple onchange="" size="1">
